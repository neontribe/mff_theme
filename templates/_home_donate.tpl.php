...
<h2  style="margin-top:20px"><?= $node->field_translation10[0]['value'] ?></h2>
<div class="clr ico">
    <?php if ($language == 'fr'): ?>
    <a href="http://www.peuples-solidaires.org/ce-que-vous-pouvez-faire/don-en-ligne/"><img
            src="<?=$image_path?>/partner/peuples3.gif" alt=""/></a>

    <?php  elseif ($language == 'cz' || $language == 'en'): ?>
 ...
 <?php if ($language == 'de'): ?>
     <a style="color:white" href="http://www.banafair.de/spenden">online spenden</a>
<?php endif;?>
</div>