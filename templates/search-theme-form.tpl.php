...
?>
  ...
  <input type="text" name="search_theme_form" id="edit-search-theme-form-l" value="" class="txt" />
  <input type="submit" class="send" value="<?=t('search')?>" id="edit-submit" name="search" />
